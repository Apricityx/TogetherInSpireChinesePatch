...
@SpirePatch(clz = MainMenuButtonsPatch.LabelPatcher.class, method = "Postfix", requiredModId = "spireTogether")
public class MainMenuPanelCP
{
  public static void Postfix(MenuButton __instance)
  {
    if (Settings.language == Settings.GameLanguage.ZHS)
    {
      ...
      {
        Reflection.setFieldValue("label", __instance, "继续游戏");
      }
      else if (__instance.result == MenuButton.ClickResult.ABANDON_RUN)
      {
        Reflection.setFieldValue("label", __instance, "放弃游戏");
      }
    }
  }
}
